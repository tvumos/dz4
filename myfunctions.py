...
sep_count = 50
print('='*sep_count)
print('Test function - simple_separator')
...
print('='*sep_count)
print('Test function - long_separator')
...
print('='*sep_count)
print('Test function - hello_world')
def hello_world():
    """
...
print('='*sep_count)
print('Test function - print_key_val')
